...
% STIM1D_RANDOM -- Creates a 1-D (space) random stimulus for model computation
%
%   STIM=STIM1D_MOTION(X, T, VALUES, DISTRIBUTION)
%
...
%       
%    Example: stim = stim1d_random([0:0.1:10],[0:0.1:300],[1 0 -1],[0.1 0.8 0.1]);
%
