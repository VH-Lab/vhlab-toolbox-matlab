...
% DIRRFMODEL_EXAMPLE0 - Tests 1d kernel with a "trivial" kernel
%
...
D = createdirkernel(Dx,Dt,SpFreq,0,TFreq,Left,[3 2],[0.1 0.001 0.2],0.010);
...
[R_left_trivial,sim_time] = simulate_1dkernel_response(D_trivial, Dx,Dt, stim_left, Stimx, Stimt);
