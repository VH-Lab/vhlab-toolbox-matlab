...
%
%   [RSP,RP,OP,SIGMA,RN] = OSI2ORIPARAMS2(OSI, ...)
%
...
%   [RSP,RP,OP,SIGMA,RN] = OSI2ORIPARAMS2(OSI, 'SIGMA',40)
%
...
%          [rsp,rp,op,sigma,rn] = osi2oriparams2(i);
%          [dummy,shape] = otfit_carandini_err([rsp rp op sigma rn],[0:22.5:360-22.5]);
%          actual_index(end+1) = compute_orientationindex(0:22.5:360-22.5,shape);
%       end;
