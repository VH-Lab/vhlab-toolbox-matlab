...
% Creates a timeline plot based on a configuration provided in a JSON string.
    %
    % See also: vlt.plot.timeline, vlt.plot.timelineRow
...
%       '],', ...
%       '"timelineRows": [', ...
%       '  {"Row": 2, "Type": "RowLabel", "String": "OS", "HorizontalAlignment": "right"},', ...
...
%       '  {"Row": 3, "Type": "RowLabel", "String": "DS", "HorizontalAlignment": "right"},', ...
...
%       '  {"Row": 4, "Type": "verticalDashedBar", "T0": 32}', ...
%       ']', ...
%   '}'];
