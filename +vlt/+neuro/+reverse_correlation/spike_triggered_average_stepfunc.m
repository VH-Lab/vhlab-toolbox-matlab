...
% vlt.neuroscience.reverse_correlation.spike_triggered_average_stepfunc - Performs STA between spike times and step function stimulus
%
% AVG_STIM = vlt.neuroscience.reverse_correlation.spike_triggered_average_stepfunc(SPIKETIMES, STIM_OFFSETS, STIMTIMES, STIM)
%
