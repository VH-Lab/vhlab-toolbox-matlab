...
[dummy,inds] = vlt.math.stepfunc(stimt_with_padding,stim_with_zero_padding',stim_time_requests);

start_ind = vlt.data.findclosest(stim_time_requests,stimt(1));  % could compute this exactly
