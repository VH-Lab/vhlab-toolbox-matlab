...
%
%  OIIND = vlt.neuroscience.vision.oridir.indexes.fit2fitoidiffsum(R)
%
...
%
%    See also: vlt.fit.otfit_carandini, vlt.neuroscience.vision.oridir.indexes.fit2fitoi, vlt.neuroscience.vision.oridir.indexes.fit2fitdibr, vlt.neuroscience.vision.oridir.indexes.fit2fitdidiffsum
...
oiindfit = (R(OtPi)+R(OtNi)-R(OtO1i)-R(OtO2i))/(R(OtPi)+R(OtNi)+R(OtO1i)+R(OtO2i));
