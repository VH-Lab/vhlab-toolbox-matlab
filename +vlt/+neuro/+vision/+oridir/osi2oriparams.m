...
%
%   [RSP,RP,OP,SIGMA,RN] = vlt.neuroscience.vision.oridir.osi2oriparams(OSI, ...)
%
...
%   [RSP,RP,OP,SIGMA,RN] = vlt.neuroscience.vision.oridir.osi2oriparams(OSI, 'SIGMA',40)
%
...
%          [rsp,rp,op,sigma,rn] = vlt.neuroscience.vision.oridir.osi2oriparams(i);
