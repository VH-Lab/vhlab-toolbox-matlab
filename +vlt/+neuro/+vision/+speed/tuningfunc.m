function R = tuningfunc(SF,TF,P)
    % SPEED.TUNINGFUNC Plot responses
    %
    %  R = SPEED.TUNINGFUNC(SF,TF,P)
    %
    %  Find a neuron's preferred spatial frequency averaged across temporal
    %  frequencies.
    %
    %  Inputs:
    ...
    %
    %  Example:
    %    [SF,TF] = meshgrid([0.05 0.08 0.1 0.2 0.4 0.8 1.2],[0.5 1 2 4 8 16
    %    32]);
    ...
    %
        ...
        SF = SF(:); TF = TF(:); % Make them column vectors
