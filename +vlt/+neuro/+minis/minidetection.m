...
if do_detrend_median,
	for R=1:r,
		data(R,:) = vlt.signal.detrend_median(data(R,:),si,detrend_timescale);
	end;
end;
...
%for R=1:r,
	%matched = conv(data(R
%	[index_up, index_down, row_minisamples{R}] = vlt.signal.threshold_crossings_epochs(data(R,:), threshold);
