...
%
%  See also: vlt.neuroscience.mledenoise.testSlowMLE for an example where the response is a 
...
spike_response = vlt.neuroscience.spiketrains.spikeresponse_tf(stimon,stimoff,stimids,spiketimes,dt,freq);
...
[s_i_params, g_params, sinparams, mle, responseobserved, stimlist, responses_s_i] = ...
	vlt.neuroscience.mledenoise.SlowMLEDeNoise(stimon, stimoff, stimids, spiketimes,'showfitting',1,'numIterations',6,...
