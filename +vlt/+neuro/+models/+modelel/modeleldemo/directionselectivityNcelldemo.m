...
%
%  [MODELEL, DI, R_UP, R_DOWN] = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo
%
%  Enter "TYPE vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo" to see the code.
%
...
%     [mel,di,rup,rdown]=vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo;
%
%     % a direction-selective model
%     [mel,di,rup,rdown]=vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo('Syn_Gmax_initial',[0 4 4 0]*1e-9);
%
%     % a 3 by 3 cell model
%     [mod,di,r_up,r_down] = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo('N',3,'R',3,'isi',1);
%
%     % a 10 position by 3 latency cell model:
%     [mod,di,r_up,r_down] = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo('N',10,'R',3,'isi',3);
%
...
mel = vlt.neuro.models.modelel.neuronmodelel.spiketimelistel.spiketimelistel_init('name','dummy','spiketimes',[]);
