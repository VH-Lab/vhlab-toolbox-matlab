...
%
%   [GSYN,F] = vlt.neuroscience.models.modelel.modeleldemo.intfireleaky_Gsyn_vs_F(INTFIREEL, SYNAPSEEL,
...
%   steps.
%
%   See also: vlt.neuroscience.models.modelel.neuronmodelel.intfiremodels.intfireleakyel_init, SYNAPSEEL_INIT , vlt.neuroscience.models.modelel.modeleldemo.intfireleaky_GsynAP
...
for g = 1:length(Gsyn),
	...
	modelout = vlt.neuroscience.models.modelel.modelelrun.modelelrun(modelhere,'Steps',timesteps);
