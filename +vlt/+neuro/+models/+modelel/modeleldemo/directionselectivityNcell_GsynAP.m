...
%
%   GSYNAP=vlt.neuro.models.modelel.modeleldemo.directionselectivityNcell_GsynAP(SEARCHRANGE, SIZEINPUTS, RESPONSE, WEIGHT, DIR, PARAM1, VALUE1, ...);
%
%   Determine minimum conducance necessary to generate RESPONSE action potentials
%   in a single sweep over a model generated by vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo.
...
%    GsynAP = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcell_GsynAP([],[2 2],[],[]); % use defaults
% 
%    GsynAP = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcell_GsynAP([],[5 5],[],[],'N',5,'R',5,'isi',2);
% 
%
%   See also: vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo
...
if searchsteps>0,
	for n=1:3,
		...
		if isnan(bstatus(n)), % need to test bound
			...
			[dummy,dummy2,r_up,r_down] = vlt.neuro.models.modelel.modeleldemo.directionselectivityNcelldemo(varargin{:}, dir_not_to_do_str,0,...
