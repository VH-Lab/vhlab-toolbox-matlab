...
%
% See the code: type vlt.neuro.models.modelel.modeleldemo.intfireleaky_synapsedemo
%   

 % constant current test

mel(1) = vlt.neuro.models.modelel.neuronmodelel.intfiremodels.intfireleakyel_init('name','post','synapse_list',3);
mel(2) = vlt.neuro.models.modelel.neuronmodelel.spiketimelistel.spiketimelistel_init('name','pre','spiketimes',0.1); 
mel(3) = vlt.neuro.models.modelel.synapseel.synapset1t2el.synapset1t2el_init('name','synapse','pre',2,'post',1,'Gmax',0.5e-9);
...
[modelrun,varsout] = vlt.neuro.models.modelel.modelelrun.modelelrun(mel,'Steps',steps,'Variables',varstosave);
