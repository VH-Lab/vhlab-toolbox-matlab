...
%
%   SPIKETIMELIST= vlt.neuro.models.modelel.neuronmodelel.spiketimelistel.spiketimelistel_init
%       or
%   SPIKETIMELIST = vlt.neuro.models.modelel.neuronmodelel.spiketimelistel.spiketimelistel_init(PARAM1NAME, PARAM1VALUE, ...)
%
...
spiketimelistel = vlt.neuro.models.modelel.modelel.modelel_init('model',spiketimestruct,varargin{:});
