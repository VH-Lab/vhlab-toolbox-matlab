classdef test_isinwhere < matlab.unittest.TestCase
    ...
    methods(Test)
        function test_isinwhere_logic(testCase)
            ...
            b_inside = vlt.matlab.graphics.isinwhere(rect_inside, 'normalized', where);
            ...
            b_outside = vlt.matlab.graphics.isinwhere(rect_outside, 'normalized', where);
            ...
            b_wide = vlt.matlab.graphics.isinwhere(rect_wide, 'normalized', where);
            ...
            b_same = vlt.matlab.graphics.isinwhere(rect_same, 'normalized', where);
            ...
            % This test case previously failed due to a bug in the original function.
            ...
            b_overlap = vlt.matlab.graphics.isinwhere(rect_overlap, 'normalized', where);
