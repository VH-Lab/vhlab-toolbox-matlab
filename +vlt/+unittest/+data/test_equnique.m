classdef test_equnique < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_empty_input(testCase)
            ...
            testCase.verifyTrue(isempty(vlt.data.equnique([])), 'Empty input should result in empty output');
        end
        ...
        function test_numeric_vector(testCase)
            ...
            input = [1 5 1 3 5];
            expected = [1; 5; 3];
            actual = vlt.data.equnique(input);
        ...
        function test_output_is_column(testCase)
            ...
            actual_cell = vlt.data.equnique(input_row_cell);
