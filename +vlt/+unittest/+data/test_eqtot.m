classdef test_eqtot < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function test_one_empty(testCase)
            ...
            testCase.verifyEqual(vlt.data.eqtot(5, []), 0, 'First not, second empty should return 0');
            testCase.verifyEqual(vlt.data.eqtot([1 2], []), 0, 'Non-empty vs empty should return 0');
            testCase.verifyEqual(vlt.data.eqtot([], [1 2]), 0, 'Empty vs non-empty should return 0');
        end
