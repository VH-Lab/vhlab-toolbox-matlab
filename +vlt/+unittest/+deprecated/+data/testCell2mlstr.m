    ...
    methods (Test)
        function testSimpleCell(testCase)
            ...
            expectedStr = ['<CELL size=[1 3] data=' sprintf('\n') ...
                           '     <''test''>' sprintf('\n') ...
                           '     <[5]>' sprintf('\n') ...
                           '     <[[3 4 5]]>' sprintf('\n') ... % Corrected: extra brackets
                           '/CELL>'];
            actualStr = cell2mlstr(A);
        ...
        function testNestedCell(testCase)
            ...
            B = {'nested', {'a', 1}};
            % Corrected: removed 'indent=5' from the expected string
        ...
        function testCellWithStruct(testCase)
            ...
            % This might need adjustment based on struct2mlstr's exact output
            structStr = struct2mlstr(S, 'indent', 5);
