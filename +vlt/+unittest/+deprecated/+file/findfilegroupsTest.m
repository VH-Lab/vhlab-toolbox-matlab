classdef findfilegroupsTest < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_wildcard_search(testCase)
            fileparameters = {'.*\.ext$'};
            filelist = findfilegroups(fullfile(testCase.testDir, 'test1'), fileparameters);
        ...
        function test_cooccurring_files(testCase)
            ...
            filelist = findfilegroups(fullfile(testCase.testDir, 'test2'), fileparameters);
        ...
        function test_common_substring(testCase)
            ...
            filelist = findfilegroups(fullfile(testCase.testDir, 'test3'), fileparameters);
        ...
        function test_search_depth(testCase)
            fileparameters = {'.*\.ext$'};
            filelist = findfilegroups(fullfile(testCase.testDir, 'test1'), fileparameters, 'SearchDepth', 0);
