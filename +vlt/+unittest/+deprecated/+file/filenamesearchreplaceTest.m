classdef filenamesearchreplaceTest < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_simple_rename(testCase)
            ...
            filenamesearchreplace(testCase.testDir, {'test'}, {'renamed'});
        ...
        function test_delete_original(testCase)
            ...
            filenamesearchreplace(testCase.testDir, {'test'}, {'renamed'}, 'deleteOriginals', 1);
        ...
        function test_recursive(testCase)
            ...
            filenamesearchreplace(testCase.testDir, {'test'}, {'renamed'}, 'recursive', 1);
        ...
        function test_noop(testCase)
            ...
            filenamesearchreplace(testCase.testDir, {'test'}, {'renamed'}, 'noOp', 1);
