classdef filebackupTest < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_delete_orig(testCase)
            ...
            backupname = vlt.file.filebackup(fname, 'DeleteOrig', 1);
        ...
        function test_multiple_backups(testCase)
            ...
            backup1 = vlt.file.filebackup(fname);
            backup2 = vlt.file.filebackup(fname);
        ...
        function test_custom_digits(testCase)
            ...
            backupname = vlt.file.filebackup(fname, 'Digits', 5);
        ...
        function test_error_if_digits_exceeded(testCase)
            ...
            testCase.verifyError(@() vlt.file.filebackup(fname, 'Digits', 1, 'ErrorIfDigitsExceeded', 1), '');
        end
        ...
        function test_no_error_if_digits_exceeded(testCase)
            ...
            backupname = vlt.file.filebackup(fname, 'Digits', 1, 'ErrorIfDigitsExceeded', 0);
