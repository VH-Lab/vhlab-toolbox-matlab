...
%
% [MEAN_V, MEAN_FR, STIMID, STIMPRES, VMOPSPERSTIM, FROBSPERSTIM] = VOLTAGE_FIRINGRATE_OBSERVATIONS_PER_STIMULUS(...
...
for i=1:size(stim_onsetoffsetid,1),
	stimpres(i) = findclosest(stim_onsetoffsetid_orig(:,1),stim_onsetoffsetid(i,1));
