...
SpFreq = 1; TFreq = 4; Left = 1; Right = -1; Stim_Center_Position = 3;
 ...
 % make the kernel
D = createdirkernel(Dx,Dt,SpFreq,0,TFreq,Left,[Stim_Center_Position 2],[0.1 0.001 0.2],0.03); % assume V output
...
Rspikerate_random = 5*rectify(R_random*10);  % non-linear spike function (rectification)
...
[computed_kernel, computed_kernel_unfiltered, xc_stimsignal, xc_stimstim] = ...
	reverse_correlation_stepfunc(spiketimes,sim_time_spikes,kerneltimes,Stimt,stim_random,...
