...
dlt_detector = vlt.signal.timeseriesDetectorML.dlt(detectorSamples, [], dlt_options);
dlt_detector.DLToptions.ValidationData = {reshape(X_validation, [detectorSamples, 1, 1, size(X_validation,2)]), categorical(Y_validation)};
