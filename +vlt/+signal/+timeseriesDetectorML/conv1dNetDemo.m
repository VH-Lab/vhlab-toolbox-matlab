...
[obs_neg, tf_neg, random_negative_times] = vlt.signal.timeseriesDetectorML.base.timeStamps2NegativeObservations(...
    t, timeSeriesData, ground_truth_event_times, detectorSamples, ...
...
cnn_detector.DLToptions.ValidationData = {reshape(X_validation, [detectorSamples, 1, 1, size(X_validation,2)]), categorical(Y_validation)};
