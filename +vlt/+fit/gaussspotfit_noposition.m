...
x = lsqcurvefit(@(x,xdata) vlt.math.ellipse_on_mvnpdf_noposition_x0(x,xdata,X,Y),StartPoint,ellipse_params,response,Lower,Upper);

fit_responses = vlt.math.ellipse_on_mvnpdf_noposition_x0(x,ellipse_params,X,Y);
