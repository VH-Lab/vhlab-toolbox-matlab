...
x = lsqcurvefit(@(x,xdata) ellipse_on_mvnskewpdf_x0(x,xdata,X,Y),StartPoint,ellipse_params,response,Lower,Upper);

fit_responses = ellipse_on_mvnskewpdf_x0(x,ellipse_params,X,Y);
