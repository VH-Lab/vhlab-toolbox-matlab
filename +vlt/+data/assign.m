...
% VLT.DATA.ASSIGN - Assign variables in the caller's workspace
%
%   VLT.DATA.ASSIGN('VAR1', VAL1, 'VAR2', VAL2, ...)
%
%   Makes the assignments VAR1 = VAL1; VAR2 = VAL2; ... in the caller's
%   workspace.
%
%   This is most useful when passing in an option list to a function.
%   Thus in the function which starts:
