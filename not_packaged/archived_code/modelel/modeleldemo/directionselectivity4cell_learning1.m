...
[model_initial,di(1),r_up(1),r_down(1)] = directionselectivity4celldemo('dt',dt,...
...
syn_nums = modelelgetsyn(model_initial,[1 2 3 4],[5 5 5 5]);
...
for t=2:trials,
	...
	[dummy,dummy,r_up(t),dummy,model_current] = directionselectivity4celldemo('dt',dt,...
		'latency',latency,'lag',lag,...
	...
	[dummy,dummy,dummy,r_down(t)] = directionselectivity4celldemo('dt',dt,'latency',latency','lag',lag,...
