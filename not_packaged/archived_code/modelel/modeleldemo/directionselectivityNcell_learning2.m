...
[model_initial,di(1),r_up(1),r_down(1),dummy,dummy,inhib_r_up(1),inhib_r_down(1)] = directionselectivityNcelldemo_inhib('dt',dt,...
...
inhibsyn_nums = modelelgetsyn(model_initial,[1:N*R],N*R+1+ones(1,N*R));
...
for t=2:trialstepsize:total_trials,
	...
	if unidir==1 | (mod(t,2)==0),
		...
		[dummy,dummy,r_up(t),dummy,model_current,dummy,inhib_r_up(t)] = directionselectivityNcelldemo_inhib('dt',dt,...
	...
	% figure out the 'down' spikes
		...
		[dummy,dummy,dummy,r_down(t),dummy,model_current,dummy,inhib_r_down(t)] = directionselectivityNcelldemo_inhib('dt',dt,...
		'R', R, 'N', N, 'isi', isi, 'nreps',nreps,...
