...
%
% See the code: type INTFIRELEAKY_SYNAPSEDEMO
%   

 % constant current test

mel(1) = intfireleakyel_init('name','post','synapse_list',3);
mel(2) = spiketimelistel_init('name','pre','spiketimes',0.1); 
mel(3) = synapset1t2el_init('name','synapse','pre',2,'post',1,'Gmax',0.5e-9);
