...
%  array.
%  [MODELELRUNSTRUCT,VARS] = MODELELRUN(MODELEL, PARAM1NAME, PARAM1VALUE, ...)
%  
...
for n=1:modelrunstruct.Steps,
	if mod(n,modelrunstruct.Verbose)==0,
		disp(['modelelrun: currently on step ' int2str(n) ' of ' int2str(modelrunstruct.Steps) '.']);
	end;
